...
module.exports = function(Ravel) {
  Ravel.AuthorizationProvider = function(name) {
     ...
     */
    this.init = function() {
      throw new Ravel.ApplicationError.NotImplemented('AuthorizationProvider ' + this.name + ' must implement init(expressApp, passport, verify)');
    };
    ...
    this.handlesClient = function() {
      throw new Ravel.ApplicationError.NotImplemented('AuthorizationProvider ' + this.name + ' must implement handlesClient(connection, finalErr, callback)');
    };
    ...
    this.tokenToProfile = function() {
      throw new Ravel.ApplicationError.NotImplemented('AuthorizationProvider ' + this.name + ' must implement tokenToProfile(token, client, callback)');
    };
