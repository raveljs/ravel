 ...
 *
 * Decorating a method with @before in a Routes or Resource class
 * allows the client to register middleware which should run
 * before that handler. Decorating a Routes orResource class itself
