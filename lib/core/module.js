 ...
 *
 *     aMethod () {
 *       // since we didn't extend Ravel.Momdule, we can't use this.log here.
 *     }
 *   }
 *
 *   module.exports = MyModule
...
class Module {
   ...
   * pattern (see [db/decorators/transaction](../db/decorators/transaction.js.html)).
...
module.exports = function (Ravel) {
   ...
   * your `Module` a custom name. Instead, use `app.modules` (see [core/modules](modules.js.html)).
   *
   * @memberof Ravel
