...
const buildRoute = function(ravelInstance, routes, koaRouter, methodName, meta) {
  ...
  if (Metadata.getMethodMeta(routes, methodName, '@transaction')) {
    dbProviders = dbProviders ? dbProviders : [];
  ...
  if (meta.endpoint) {
    middleware.push(function*(next) {
      ...
      // yield promises and generators/functions so that exceptions can be caught properly
      if (result instanceof Promise || result instanceof Function) {
        yield result;
      }
      yield next;
    });
