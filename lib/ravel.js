...
module.exports = function() {
  ...
  require('./core/params')(Ravel, knownParameters, params);

  //init dependency injection utility, which is used by most everything else
  var injector = require('./util/injector')(Ravel, moduleFactories, module.parent);

  //init module registration (Ravel.module)
  require('./core/module')(Ravel, moduleFactories, injector);

  //init routes registration (Ravel.routes)
  require('./core/route')(Ravel, routesFactories, injector);

  //init resource registration (Ravel.resource)
  require('./core/resource')(Ravel, resourceFactories, injector);

  //init websocket room registration (Ravel.room)
  require('./core/room')(Ravel, rooms);
  ...
  Ravel.start = function() {
    ...
    var broadcast = require('./auth/primus_init.js')(Ravel, primus, expressSessionStore, require('./util/websocket_room_resolver')(rooms));
