...
class Ravel extends EventEmitter {
  constructor() {
    ...
    this[coreSymbols.injector] = new (require('./util/injector'))(this, module.parent);
  ...
  init() {
    ...
    //Create koa server
    Ravel.server = http.createServer(app.callback());
  ...
  listen(done) {
    ...
    //Start Koa server
    this.server.listen(this.get('port'), function(){
