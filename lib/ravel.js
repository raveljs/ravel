...
const sParams = Symbol('_params');
const sKnownParameters = Symbol('_knownParamters');
...
class Ravel extends EventEmitter {
  constructor() {
    ...
    this[sKnownParameters] = Object.create(null);
    this[sParams] = Object.create(null);
...
require('./core/params')(Ravel, sParams, sKnownParameters);
