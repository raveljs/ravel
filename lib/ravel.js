...
class Ravel extends EventEmitter {
  ...
  constructor() {
    ...
    // database providers
    this.registerParameter('database providers', true);
    this.set('database providers', []); // we need this parameter actually set before Ravel.init()
    // authentication providers
    this.registerParameter('authentication providers', true);
    this.set('authentication providers', []); // we need this parameter actually set before Ravel.init()
    // redis parameters
   ...
   * See [`util/log.js`](util/log.js.html) for more information.
   * @type {Logger}
   * @example
 ...
 * [`db/database_provider`](db/database_provider.js.html) for more information.
 * @example
...
/**
 * Initializer for all registered database providers
 * @api private
 */
Ravel.prototype[dbSymbols.databaseProviderInit] = require('./db/database_provider').init;

/**
 * The base class for Ravel `AuthenticationProvider`s. See
 * [`auth/authentication_provider`](auth/authentication_provider.js.html) for more information.
 * @example
 ...
 *   }
 */
Ravel.AuthenticationProvider = require('./auth/authentication_provider');
 ...
 * See [`core/params`](core/params.js.html) for more information.
 * @example
 ...
 * [`core/module`](core/module.js.html) for more information.
 * @example
 ...
 * See [`core/module`](core/module.js.html) for more information.
 * @example
 ...
 * See [`core/modules`](core/modules.js.html) for more information.
 * @example
 ...
 * [`core/routes`](core/routes.js.html) for more information.
 * @example
 ...
 * See [`core/routes`](core/routes.js.html) for more information.
 * @example
 ...
 * [`core/resource`](core/resource.js.html) for more information.
 * @example
 ...
 * See [`core/resource`](core/resource.js.html) for more information.
 * @example
 ...
 *
 * See [`core/resources`](core/resources.js.html) for more information.
 * @example
 ...
 *
 * See [`core/reflect`](core/reflect.js.html) for more information.
 * @example
