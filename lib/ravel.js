...
module.exports = function() {
  ...
  var injector = require('./util/injector')(Ravel, Ravel._moduleFactories, module.parent);
  ...
  Ravel.start = function() {
    ...
    var broadcast = require('./auth/primus_init.js')(Ravel, primus, expressSessionStore, require('./util/websocket_room_resolver')(Ravel._rooms));
