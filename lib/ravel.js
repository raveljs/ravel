...
module.exports = function() {
  ...
  Ravel.on = function(e, func) {
    return Ravel._eventEmitter.on(e, func);
  };
  Ravel.once = function(e, func) {
    return Ravel._eventEmitter.once(e, func);
  };
  ...
  Ravel.init = function() {
    ...
    var primus = new Primus(Ravel._server, { transformer: 'websockets', parser: 'JSON' });
    //primus_init produces a configured, cluster-ready broadcasting library
    var broadcast = require('./auth/primus_init.js')(
      Ravel, injector, primus, expressSessionStore, require('./util/websocket_room_resolver')(Ravel._rooms));
