 ...
 */
module.exports.buildRestResponse = function(req, res, err, result, okCode, options) {
  if (okCode === undefined) {
    if (result) {
 ...
 */
module.exports.handleRangeGet = function(req, res, totalCountFn, getFn, idArgs) {
  ...
  if (req.headers['Range']) {
    ...
    totalCountArgs.push(function(err, count) {
      ...
      if (!range) {
        ...
        rest.buildRestResponse(lib, req, res, new ApplicationError.RangeOutOfBounds(), undefined);
      } else if (range === -2) {
        rest.buildRestResponse(lib, req, res, new ApplicationError.RangeOutOfBounds(), undefined);
      } else {
        idArgs.push(
