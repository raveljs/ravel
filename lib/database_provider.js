...
module.exports = function(Ravel) {
  Ravel.DatabaseProvider = function(name) {
    ...
    this.getTransactionConnection = function() {
      throw new ApplicationError.NotImplemented('DatabaseProvider ' + this.name + ' must implement getTransactionConnection(callback)');
    };
    ...
    this.exitTransaction = function() {
      throw new ApplicationError.NotImplemented('DatabaseProvider ' + this.name + ' must implement exitTransaction(connection, finalErr, callback)');
    };
    return this;
  };
};