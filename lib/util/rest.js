...
module.exports = function(Ravel) {
   ...
   */
  var buildRestResponse = function(req, res, err, result, okCode, options) {
    if (okCode === undefined) {
   ...
   *                    those values.
   */
  Rest.respond = function(req, res, okCode, options) {
    return function(err, result) {
      return buildRestResponse(req, res, err, result, okCode, options);
    };
  };
