...
class DatabaseProvider {
   ...
   * Ravel application via `app.use()` should happen here. This includes, but is
   * not limited to, the declaration of parameters supporting this module via
   * `ravelInstance.registerParameter()`. If you override this constructor,
...
/*!
 * Export accessor for DatabaseProviders list
 */
